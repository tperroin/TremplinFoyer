...
/* TperroinTremplinFoyerBundle:Association:edit.html.twig */
class __TwigTemplate_afedd5af13272dc88b4e171f205e737d extends Twig_Template
{
    ...
    {
        // line 1
        echo "<h1>Association edit</h1>

<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("association_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "TperroinTremplinFoyerBundle:Association:edit.html.twig";
    }
